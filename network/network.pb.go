...
var fileDescriptor_8571034d60397816 = []byte{
	...
	,
}
...
type NodeNetworkClient interface {
	...
	// 検証結果を報告
	ValidateNonce(ctx context.Context, in *MinerInfo, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *nodeNetworkClient) ValidateNonce(ctx context.Context, in *MinerInfo, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type NodeNetworkServer interface {
	...
	// 検証結果を報告
	ValidateNonce(context.Context, *MinerInfo) (*Response, error)
}
...
func (*UnimplementedNodeNetworkServer) ValidateNonce(ctx context.Context, req *MinerInfo) (*Response, error) {
